...
class MainProcessor:
    ...
    def __init__(self, camera_id):
        ...
        if camera_id == 'cam_01' or camera_id == 'cam_03' or camera_id == 'cam_05':
        ...
        elif camera_id == 'cam_06':
            self.processor = DirectionViolationDetection(self.cam_feed)

    def getProcessedImage(self, frame=None, cap=None):
        if self.cam_id in ['cam_01', 'cam_02', 'cam_03', 'cam_05']:
            dicti = self.processor.cross_violation(frame)

        elif self.cam_id == 'cam_04' or 'cam_06':
